      ...
      <div className="container">
        <div className="hero-content">
          ...
          <h1 className="hero-title delay-2">
            stdlib <span className="text-orange">numerica</span>
          </h1>

          <p className="hero-subtitle delay-3">
            An interactive platform for stdlib&apos;s numerical computing libraries.
            Explore statistical distributions, BLAS and LAPACK operations, and random sampling all running directly in your browser.
          </p>
